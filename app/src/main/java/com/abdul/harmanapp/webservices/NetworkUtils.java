...
import java.net.URL;
//https://www.googleapis.com/books/v1/volumes?q=wings%20of%20fire&maxResults=3&printType=books
...
//https://www.googleapis.com/books/v1/volumes?q=harry potter&maxResults=2&printType=books
    ...
    static String getBookInfo(String queryString) {
        ...
        try {
            ...
            urlConnection = (HttpURLConnection) requestURL.openConnection(); //connecting to the server
